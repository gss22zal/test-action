...
|-------|----------|----------|
| GET | `/` | Главная страница со списком всех эндпоинтов |
| GET | `/health` | Проверка состояния приложения |
| GET | `/info` | Информация о контейнере и версии |
| GET | `/env` | Переменные окружения |
| GET | `/time` | Текущее время сервера (UTC) |
| GET | `/date` | Текущая дата сервера |
| GET | `/datetime` | Полная дата и время сервера |
